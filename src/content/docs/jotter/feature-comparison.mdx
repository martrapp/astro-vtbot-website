...
|4|[transition:persist](#transitionpersist)|Keeping elements and their state from page to page| - |
|5|[SPA State](#spa-state) | Shared state across pages| Clean page load semantics|
|6|[Directional Animations](#directional-animations)|Browser back button slides the other way|-|
...
|10|[Generated Names](#generated-names)|Work cross-document|-|
|11|[Data Attributes](data-attributes)|Control link and script behavior|-|
