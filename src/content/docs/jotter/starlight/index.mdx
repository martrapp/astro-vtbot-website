...
|-|-|-|
|Mandatory|The basic view transition support in just three steps|[VtbotStarlight](/jotter/starlight/guide/#step-1-install-astro-vtbot)|
...
|Optional|Change the default handling of the sidebar|[VtbotStarlight](/jotter/starlight/guide/#customize-the-sidebar)|
