...
Visit the [corresponding section in the introduction](/jotter/starlight/inner-workings/#keep-app-state-up-to-date) to see where we are in  the big picture of The Bag's Starlight support.
...
> **Spoiler**: *The first assumptions does not hold* when we navigate to pages with a different layout, especially the `splash` layout. Read more about the consequences [on the next page](/jotter/starlight/inner-workings/sidebar/)!
