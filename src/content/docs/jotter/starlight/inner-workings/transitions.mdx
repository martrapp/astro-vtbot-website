...
Visit the [corresponding section in the introduction](/jotter/starlight/inner-workings/#add-transition-directives) to see where we are in  the big picture of The Bag's Starlight support.
