...
This part of the Jotter explains how the Starlight integration of The Bag works. You might want to read on if you want to know about the inner workings. If you just want to use the Starlight support, [head over to the guide](/jotter/starlight/guide/).
