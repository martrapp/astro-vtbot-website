...
* Gives you the ability to add visual transition effects to navigation
...
The replacement component covers all aspects classified as [mandatory actions](/jotter/starlight/#mandatory-actions).
...
This section shows how to add features from the [optional feature list](/jotter/starlight/#optional-part). This just has a single entry right now but will soon grow further.
