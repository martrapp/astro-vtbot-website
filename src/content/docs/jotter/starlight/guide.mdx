...
If you happen to use the [replaceSidebarContent option](#replace-the-sidebar-content) you should update vtbot to 0.18.5 to benefit from this huge improvement!
:::
