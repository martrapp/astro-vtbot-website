...
If you happen to use the [replaceSidebarContent option](#replace-the-sidebar-content) you should update `astro-vtbot` to 1.18.5 or higher to benefit from this huge improvement!
:::
