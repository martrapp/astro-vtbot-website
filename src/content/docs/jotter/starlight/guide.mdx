---
title: How to Add Astro's View Transitions to Starlight for a SPA like Look & Feel
---
...
* Looks like a SPA: No full page reloads anymore
* Behaves like a SPA: Search terms, sidebar scroll position and collapsed category states are retained across navigation
