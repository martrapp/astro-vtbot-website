...
The Bag's view transition support keeps the app frame of the Starlight site unchanged  and  [only swaps the main-frame](/jotter/starlight/app-state/) inside it on transitions. While you could  use the sidebar for navigation this way, it would look a bit odd if the current page marker wouldn't change. So we need some script to update the current page marker in the sidebar ourselves. And that's it.
...
**Revealed:** This now reveals what is behind [Line 20](/jotter/starlight/integration/#connecting-to-starlight) of the StarlightConnector.
...
```
**Revealed:** This listing reveals what's behind [Line 14](/jotter/starlight/integration/#connecting-to-starlight) of the StarlightConnector.
...
**Revealed:** How do we close the mobile menu on navigation? This reveals what is hidden behind [Line 15](/jotter/starlight/integration/#connecting-to-starlight) of the StarlightConnector.
