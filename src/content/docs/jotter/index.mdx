...
At the time of writing, the world is split in two: Chromium-based browsers (Chrome, Edge, Opera, ...) have native support for view transitions, all others do not. Check out the capabilities of your current browser on the test page!
