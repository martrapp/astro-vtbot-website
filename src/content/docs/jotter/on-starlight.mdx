...
#### Disable the Linter
Starlight uses the `where` scoped styles strategy. The Bag's [Linter](/library/Linter/) is not prepared for this and complains about styles being defined but not used. Because I added the linter as part of the integration to all pages, I did get a lot of those warnings. Until I get a chance to make the Linter smarter, I switched it of:
