...
The simplest way to explore the View Transition API for same-document view transitions in Astro is to install [`@vtbag/utensil-drawer`](https://vtbag.dev/tools/utensil-drawer/#maystartviewtransition) from npm and then start from this example file: 
