...
The the section on [pseudo-scrolling morph animations](/jotter/starlight/inner-workings/transitions/#the-pseudo-scrolling-main-area) if you are interested in the details.
