...
This is how you call `window.document.startViewTransition()`. The result contains some promises and a function to cancel the visual transition. For [details see the API description](/jotter/api/details/).
