...
|2024-04-05 | Optimized Morph transition for large content|[Starlight Overview](/jotter/starlight/#no-more-annoying-scrolling-on-transitions)|
...
|2024-04-03|Better always provide a `<slot/>` when overriding Starlight components. One never knows.|[Starlight Guide](/jotter/starlight/guide/#create-the-new-head-component)|
