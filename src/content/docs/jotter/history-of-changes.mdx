...
|When|What|Where|
|----|-----|----|
|2025-03-14|Updated the conditions for scripts not being executed by the Client Router|[script behavior](/jotter/astro/scripts/#behavior-with-view-transitions	)|
