...
<h1 style="display: inline-block; view-transition-name: signal1"><span style="display:inline-block; view-transition-name:signal-2;">🔙 </span>The Turn-Signal</h1>
...
<span style="display: inline-block; font-size: 1.5rem; color: black; border-radius: 8px; padding: 1rem; margin: 1rem; background: linear-gradient(45deg, #000, #f0659588, #cc5de8); box-shadow: 0 4px 6px #8888;">[Visit the demos](/signal-demo/) on how to use this component.</span>
