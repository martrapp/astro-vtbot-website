...
Need more fine graned control? Maybe we need an attribute on the link to enable per link control over the scroll behavior. What do you think? [Join the discussion](https://github.com/martrapp/astro-vtbot/discussions/35).
