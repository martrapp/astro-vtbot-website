...
## How Does it Work?
The Inspection Chamber wraps around your page and adds a control panel that you can use to examine your view transition animations. The Inspection Chamber of the <Logo/> Bag of Tricks is the Astro version of the `@vtbag/InspectionChamber`. Please see the [documentation there](https://vtbag.pages.dev/InspectionChamber) for further information.
