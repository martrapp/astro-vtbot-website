...
```css title="animation.css" {2} "perspective"
	::view-transition-image-pair(*) {
		perspective: 50cm;
	}
```
The animations offered by the Bag of Tricks generate this for you, so you are save on browsers that natively support view transitions.
