...
```
to switch on the [experimental over-the-top flavor](https://vtbag.pages.dev/http:/tools/element-crossing/#element-crossing-experimental-over-the-top) of the Element Crossing.

Visit the [documentation on how to annotate HTML elements](https://vtbag.pages.dev/http:/tools/element-crossing/#configuration) for info about configuration and real word examples.
