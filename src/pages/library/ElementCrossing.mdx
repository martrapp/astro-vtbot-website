...
```
to switch on the [experimental over-the-top flavor](https://vtbag.dev/tools/element-crossing/#over-the-top-features) of the Element Crossing.

Visit the [documentation on how to annotate HTML elements](https://vtbag.dev/tools/element-crossing/#vanilla-configuration) for info about configuration and real word examples.
