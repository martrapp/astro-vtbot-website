...
Visit the [documentation on how to annotate HTML elements](https://vtbag.pages.dev/tools/element-crossing/#configuration) for info about configuration and real word examples.
