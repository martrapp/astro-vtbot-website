...
```
If you are happy with the default loading indicator html you can keep it. Otherwise you define your own, see line 10 above and [the section on alternative elements](#alternative-2-use-the-loadingindicator--component).
